...
void Int_ACMP_Handler(void)               WEAK_DEFAULT_HANDLER;
...
void Int_KBI_Handler(void)               WEAK_DEFAULT_HANDLER;
...
void Int_RTC_Handler(void)               WEAK_DEFAULT_HANDLER;
void Int_TPM3_Ch0_Handler(void)               WEAK_DEFAULT_HANDLER;
void Int_TPM3_Ch1_Handler(void)               WEAK_DEFAULT_HANDLER;
void Int_TPM3_Ch2_Handler(void)               WEAK_DEFAULT_HANDLER;
void Int_TPM3_Ch3_Handler(void)               WEAK_DEFAULT_HANDLER;
void Int_TPM3_Ch4_Handler(void)               WEAK_DEFAULT_HANDLER;
void Int_TPM3_Ch5_Handler(void)               WEAK_DEFAULT_HANDLER;
void Int_TPM3_Ovf_Handler(void)               WEAK_DEFAULT_HANDLER;
...
VectorTable const __vector_table = {
   ...
   &__StackTop,                           /*    0  Initial stack pointer                                                  */
   {
	  ...
	  Int_Irq_Handler,                    /*   64                                              */
	  Int_LVD_Handler,             		  /*   65                                              */
	  Int_TPM1_Ch0_Handler,				  /*   66																		  */
	  Int_TPM1_Ch1_Handler,				  /*   67																		  */
	  Int_TPM1_Ch2_Handler,				  /*   68																		  */
	  Int_TPM1_Ovf_Handler,				  /*   69																		  */
	  Int_TPM2_Ch0_Handler,				  /*   70																		  */
	  Int_TPM2_Ch1_Handler,				  /*   71																		  */
	  Int_TPM2_Ch2_Handler,				  /*   72																		  */
	  Int_TPM2_Ovf_Handler,				  /*   73																		  */
	  Int_SPI2_Handler,				      /*   74                     		                                              */
	  Int_SPI1_Handler,				      /*   75                     		                                              */
	  Int_SCI1_Err_Handler,		          /*   76                     		                                              */
	  Int_SCI1_Rx_Handler,		          /*   77                     		                                              */
	  Int_SCI1_Tx_Handler,		          /*   78                     		                                              */
	  Int_I2C_Handler,		              /*   79                     		                                              */
	  Int_KBI_Handler,		              /*   80                     		                                              */
	  Int_ADC_Handler,				      /*   81							                                              */
	  Int_ACMP_Handler,		              /*   82                     		                                              */
	  Int_SCI2_Err_Handler,		          /*   83							                                              */
	  Int_SCI2_Rx_Handler,		          /*   84							                                              */
	  Int_SCI2_Tx_Handler,		          /*   85							                                              */
	  Int_RTC_Handler,		              /*   86                     		                                              */
	  Int_TPM3_Ch0_Handler,				  /*   87																		  */
	  Int_TPM3_Ch1_Handler,				  /*   88																		  */
	  Int_TPM3_Ch2_Handler,				  /*   89																		  */
	  Int_TPM3_Ch3_Handler,				  /*   90																		  */
	  Int_TPM3_Ch4_Handler,				  /*   91																		  */
	  Int_TPM3_Ch5_Handler,				  /*   92																		  */
	  Int_TPM3_Ovf_Handler,				  /*   93																		  */
	  Default_Handler,                    /*   94  Uninitialised Interrupt                                                */
	  Default_Handler,                    /*   95  Uninitialised Interrupt                                                */
	  Int_L7_SWI_Handler,                 /* 96                                              */
	  Int_L6_SWI_Handler,                 /* 97                                              */
	  Int_L5_SWI_Handler,                 /* 98                                              */
	  Int_L4_SWI_Handler,                 /* 99                                              */
	  Int_L3_SWI_Handler,                 /* 100                                              */
	  Int_L2_SWI_Handler,                 /* 101                                              */
	  Int_L1_SWI_Handler,                 /* 102                                              */
	  Default_Handler,                    /*  103                                                                         */
	  Default_Handler,
	  Default_Handler,
	  Default_Handler,
